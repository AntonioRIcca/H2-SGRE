...
class Ui_settings(object):
    def setupUi(self, settings):
        ...
        self.EL101_H2_LBL.setGeometry(QtCore.QRect(10, 80, 51, 20))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.EL101_H2_sep_LBL = QtWidgets.QLabel(self.EL101_GB)
        self.EL101_H2_sep_LBL.setGeometry(QtCore.QRect(150, 80, 10, 20))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.EL101_H2_sep_LBL.setFont(font)
        self.EL101_H2_sep_LBL.setAlignment(QtCore.Qt.AlignCenter)
        self.EL101_H2_sep_LBL.setObjectName("EL101_H2_sep_LBL")
        self.EL101_H2_max_DSB = QtWidgets.QDoubleSpinBox(self.EL101_GB)
        self.EL101_H2_max_DSB.setGeometry(QtCore.QRect(160, 80, 80, 20))
        self.EL101_H2_max_DSB.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.EL101_H2_max_DSB.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.EL101_H2_max_DSB.setPrefix("")
        self.EL101_H2_max_DSB.setDecimals(1)
        self.EL101_H2_max_DSB.setMinimum(0.0)
        self.EL101_H2_max_DSB.setMaximum(50.0)
        self.EL101_H2_max_DSB.setProperty("value", 5.0)
        self.EL101_H2_max_DSB.setObjectName("EL101_H2_max_DSB")
        self.EL101_H2_min_DSB = QtWidgets.QDoubleSpinBox(self.EL101_GB)
        self.EL101_H2_min_DSB.setGeometry(QtCore.QRect(70, 80, 80, 20))
        self.EL101_H2_min_DSB.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.EL101_H2_min_DSB.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.EL101_H2_min_DSB.setPrefix("")
        self.EL101_H2_min_DSB.setDecimals(1)
        self.EL101_H2_min_DSB.setMinimum(0.0)
        self.EL101_H2_min_DSB.setMaximum(50.0)
        self.EL101_H2_min_DSB.setProperty("value", 0.0)
        self.EL101_H2_min_DSB.setObjectName("EL101_H2_min_DSB")
        self.EL101_H2_act_CkB = QtWidgets.QCheckBox(self.EL101_GB)
        self.EL101_H2_act_CkB.setGeometry(QtCore.QRect(260, 80, 80, 20))
        self.EL101_H2_act_CkB.setObjectName("EL101_H2_act_CkB")
        ...
        settings.setTabOrder(self.EL101_pressure_act_CkB, self.EL101_H2_min_DSB)
        settings.setTabOrder(self.EL101_H2_min_DSB, self.EL101_H2_max_DSB)
        settings.setTabOrder(self.EL101_H2_max_DSB, self.EL101_H2_act_CkB)
        settings.setTabOrder(self.EL101_H2_act_CkB, self.ok_PB)
    ...
    def retranslateUi(self, settings):
        ...
        self.EL101_H2_LBL.setText(_translate("settings", "H2 flux"))
        ...
        self.EL101_H2_sep_LBL.setText(_translate("settings", "-"))
        self.EL101_H2_max_DSB.setSuffix(_translate("settings", " Nm3/h"))
        self.EL101_H2_min_DSB.setSuffix(_translate("settings", " Nm3/h"))
        self.EL101_H2_act_CkB.setText(_translate("settings", "Activate"))
